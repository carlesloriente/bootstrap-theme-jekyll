...
build_site() {
  ...
  rsync -avz --progress node_modules/nocc-bootstrap-theme assets/vendor/nocc-bootstrap-theme --exclude src && JEKYLL_ENV=development bundle exec jekyll build --incremental --verbose --destination _site_local --config _config.yml && ruby bin/webserver.rb
}
